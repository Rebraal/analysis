...
# restarted analysis 2021-12-20 11:00

# Strip out data from lists
def db2np(lst):
    """"Converts a result from list_content into a numpy array"""
    return np.ascontiguousarray(np.array(lst, dtype=str)[:, 0])

# this doesn't seem to work on Date yet. 2021-12-20 16:45
